    ...
    <div className={`min-h-screen ${darkMode ? 'dark bg-gray-900' : 'bg-gradient-to-r from-blue-100 to-teal-100'}`}>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle className={`text-2xl ${darkMode ? 'text-white' : 'text-blue-600'}`}>New Patient Report</CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea id="treatment" placeholder="Describe the treatment plan" />
                </div>
