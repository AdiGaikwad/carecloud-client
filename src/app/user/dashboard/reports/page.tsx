...
import { Bell, Moon, Sun,  Search, Eye } from "lucide-react";
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.Success) {
          ...
          if (res.data.reports) {
            setReports(transformDataArray(res.data.reports));
          }
                  ...
                  {filteredReports &&
                    filteredReports.map((report) => (
                      <TableRow key={report.id}>
                        ...
                        <TableCell>
                          {getStatusBadge(report.reportType)}
                        </TableCell>
                        <TableCell>{report.date}</TableCell>
                        {/* <TableCell>{getStatusBadge(report.status)}</TableCell> */}
                        <TableCell>
                          <Link
                            href={`/user/dashboard/reports/${report.id}`}
                          >
